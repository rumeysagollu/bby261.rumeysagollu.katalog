var catalog = [
    ...
    {
        "itemName":"Ölü Canlar",
        "itemAuthor":"Nikolay Vasilyeviç Gogol",
        "itemImage":"images/olu_canlar.jpg",
        "itemCreationDate":"2015",
        "itemDescription":"<p>Gogol, 19. yüzyıla damgasını vuran Ölü Canlar romanını başlangıçta üç cilt olarak tasarlamış, ikinci cildini ölmeden önce yok etmiş, üçüncü cildini yazmamıştır. Buna rağmen 1842'de yayınlanan Ölü Canlar bütünlüklü ve Rusya'daki yaşamı en ince ayrıntısına kadar yansıtan bir kitaptır. Gogol bu kitabıyla ülkesindeki çarpıklıkları sergilemiştir. <br>(Tanıtım Bülteninden)</p>"
    },
     {
        "itemName":"Palto",
        "itemAuthor":"Nikolay Vasilyeviç Gogol",
        "itemImage":"images/palto.jpg",
        "itemCreationDate":"2015",
        "itemDescription":"<p>Toplumsal hayatın kıyısında yer alan silik bir karakterin, Akakiy Akakiyeviç adlı sıradan bir devlet memurunun trajikomik hikâyesi anlatılıyor Gogol'ün Palto'sunda. Trajik olanla komik olanın ustaca bir araya getirildiği bu hikâye, gerek Rus edebiyatını gerekse dünya edebiyatını yarattığı karakter itibariyle derinden etkilemiştir. Modern hayatın bürokratik mekanizmaları içine çekilmiş, para sıkıntısı çeken, işini kaybetmekten ürken, çevresindeki insanlar tarafından sürekli aşağılanan, ezilip hor görülen bir memurdur Akakiyeviç. Kendini gerçekleştirdiği tek eylemse, şevkle yaptığı işidir: Bu işte, yani mektupları temize çekme işinde sadece kendine ait, değişik, hoş bir dünya bulurdu. İşini yaparken duyduğu mutluluk yüzünden okunurdu; bazı harfler gözdesiydi ve sıra bu harfleri yazmaya geldiğinde kendinden geçer, gözlerini kırpıştırır, gülümser ve sanki dudaklarıyla kalemine yardım ederdi. Yüzüne bakınca kaleminin ucundan hangi harfin dökülmekte olduğu kolayca anlaşılırdı.Kara kışın soğuğundan korunmak için bir paltoya ihtiyaç duyan Akakiyeviç'in, bu paltoyu güç bela edinmesiyle birlikte bütün hayatı altüst olur, komik olan yerini trajik olana bırakır…  <br>(Tanıtım Bülteninden)</p>"
    },
    {
        "itemName":"Mumu",
        "itemAuthor":"Ivan Sergeyeviç Turgenyev",
        "itemImage":"images/mumu.jpg",
        "itemCreationDate":"2015",
        "itemDescription":"<p>Nedense, Turgenyev'le epey geç tanıştım. Hayır, onu daha önce okumamıştım demek istemiyorum; bir klasik Rus yazarını okumamak nasıl mümkün olabilir? Demek istediğim, ilk defa bu çeviriyi yaparken böylesine ciddiyetle okudum onu, birçok hikâyesini gözden geçirdim, bilmediğim çok şey öğrendim hakkında. Sonra sadece kendime değil, bizim edebiyat dünyamıza da şaşırdım: biraz mürekkep yalamış herkes Turgenyev'i bilir de, Türkçeye kaç kitabı çevrilmiştir tanrı aşkına? Tolstoy'un gençliğindeki hamisi, efsanevi Sovremennik (Çağdaş) dergisinin editörlerinden biri, sayısız klasik Rus yazarını ilk keşfedenler arasında bulunan bir klasik Rus yazarı Turgenyev; ve öte yandan, çağdaşı ya da kendinden sonra gelenleri de derinden etkilemiş bir yazar. İtiraf edeyim ki, bana en şaşırtıcı gelen şudur: Turgenyev hayatının yarıdan fazlasını ülkesinden uzakta, Avrupa'da yaşamışken ?çağdaşı olup da tanışmadığı Avrupalı yazar yoktur herhalde? nasıl olur da halkını bu kadar iyi yansıtabilir eserlerinde? Hayır, abartarak söylemiyorum bunu; Turgenyev siyasetle pek az ilgilendiği halde eserlerindeki halk tasvirleri öyle etkiledi ki ülkesinin aydınlarını, Rusya'nın ikinci dalga devrimcileri olan Narodnikler onun eserlerini başucu kitabı yaptılar desem, fazla mı ileri gitmiş olurum? Romantizmden natüralizme kadar edebiyat akımlarının izini bulmak mümkündür eserlerinde; ama şu kadarını söyleyeceğim ben: Mumu'dan başka hiçbir şey yazmış olmasaydı bile Turgenyev, gene de büyük bir yazar olarak kalırdı. HY.<br>(Tanıtım Bülteninden)</p>"
    },
    {
        "itemName":"Babalar ve Oğullar",
        "itemAuthor":"Ivan Sergeyeviç Turgenyev",
        "itemImage":"images/babalar.jpg",
        "itemCreationDate":"2015",
        "itemDescription":"<p>'Romanda, geçen yüzyıl Rusya'sının toplumsal-siyasal görünümü ele alınmaktadır. Romandaki baba ve oğul karakterleri iki Rus jenerasyonu arasındaki artan bölünmüşlüğü, Yevgeniy Bazarov ise nihilist görüşleri ve eski düzen karşıtlığı ile ilk Bolşevikleri temsil eder.Dönemin Rusya'sında yaşanan geleneksellik ile bireysellik arasındaki çatışmanın adım adım gösterildiği romanda, adından da anlaşılacağı gibi babalar kuşağı, ataerkil toplumun sarsılmaz töresel inancını; oğullar ise, bütün töreleri yok sayma savaşını temsil ederler.Babalar ve Oğullar, Rus Edebiyatı'nın tam anlamıyla yazılmış ilk modern roman örneği olarak kabul edilebilir. Aynı zamanda batı dünyasında şöhret kazanan ilk Rus edebiyat çalışmasıdır.<br>(Tanıtım Bülteninden)</p>"
    },
    {
        "itemName":"İlk Aşk",
        "itemAuthor":"Ivan Sergeyeviç Turgenyev",
        "itemImage":"images/ilk_ask.jpg",
        "itemCreationDate":"2008",
        "itemDescription":"<p>'İlk Aşk'ın yazarı Turgenyev, sadece Rusya'nın değil, Dünyanın ölümsüz yazarları arasında yer almaktadır. Bu romanının kahramanı Vladimir'de kendisinden başkası değildir. Ailesi ile on altı yaşlarında yaşamış olduğu duyguları içtenlikle anlatmak için 42 yaşlarında 'İLK AŞK'ı kaleme almıştır. Geride bıraktığı o yıllardaki hislerini şöyle dillendirir: 'Ey, kısa ömürlü fırtınalar, gönülden gönüle çağlayan sesler, tertemiz bağlantılar, duygulu, düş dolu ruhlar... İlk SEvginin, ilk aşkın benliği saran sevinci! Siz nerdesiniz, nerdesiniz? Turgenyev'in yaşadığı 'İlk Aşk2ta, rakip olarak karşısına maalesef beklenmedik bir kader çizgisiyle öz babası çıkmıştır. Ne var ki, babası oğlunun yoğrulmakta olduğu o duygularından habersizdir... Yazarın yenilgiyle son bulan ve karmaşık hislerle yüklü o anıları, daha sonraki yaşamın da onu derinden etkilemiştir. Bu eserle birlikte, KARAMZİN'in 'Tüm Rusların ta okul sıralarında öğrendiği, yaşanmış, gerçek hayattan alınmış 'TALİHSİZ LİZA' adlı hikâyesine de yer verdik. Bu hikâye, tüm Rus halkının üzerinde öylesine tesir bırakmış ki, hatırası halen bugün dahi canlı tutulmaktadır. Karamzin, Liza'nın saf aşkını ve hazin sonunu, okuyucuları hemen etkileyecek bir biçimde, duygu dolu, nefis doğa tasvirleri ile bezenmiş bir anlatımla işlemiştir. 'İlk Aşk' ve 'Talihsiz Liza', diplomat-yazar Alhan Altan ARASLI tarafından Rusça aslından çevrilmiştir. Kitapta, ayrıca, Araslı'nın, Turgenyev ve Karamzin'in eserleri üzerine yaptığı bir incelemeye de yer verilmiştir.<br>(Tanıtım Bülteninden)</p>"
    },
    {
        "itemName":"Bilgelik Takvimi",
        "itemAuthor":"Lev Nikolayeviç Tolstoy",
        "itemImage":"images/bilgelik_takvimi.jpg",
        "itemCreationDate":"2003",
        "itemDescription":"<p>O adam. Uzunca sakallı. Elinde kalem; yazan adam. O yaşlı adam. Zamanın en şaşaalı, en gürültülü dönüşümlerinin yaşandığı bir yüzyılda sadece içinin fırtınalarına kulak kabartmış bir münzevi. Koyu zulümlere, katı ayırımlara zemin olmuş bir mekanın ortasından bulanmadan kalbimize akmış bir büyük düşünce ırmağı. Tolstoy, çok görmüş ve çok yaşamış 'bir suskun bilge dede' imajını tamamlar çoğu okurunun dünyasında. Sanki anlatmak için torunlarının sormasını bekliyor gibidir. Onun uzun sakallarına tutunan zamanlar ne kadar eski ve koyu ise, kaleminden beyaz sayfalara düşen notlar bir o kadar yeni ve tazedir. Zihinlerimizde yer eden o yaşlı görüntüsünün aksine, Tolstoy, milliyetin ve mekanın üzerine çıkabilmiş, zamanın ve alışkanlıkların yukarısında durabilmiş, her an değişime hazır, her an dönüşmeye çağıran bir genç sesin temsilcisi olarak dolaşıyor aramızda şimdi. Tolstoy'u hem bir bilge dede hem heyecanlı bir genç ses olarak görmenin çelişkisi, Her Güne Beş Düşünce'de çözülür. Tolstoy, bu özel eserinde, tıpkı yeni yetme bir delikanlı gibi kendi düşüncelerini besleyecek ve hayallerini zenginleştirecek sözleri toparlıyor. Kendi çağdaşları da içinde olmak üzere bir çok düşünürden süzerek topladığı sözleri, yılın her gününe yayıyor, yer yer sözlere suskun bilge dedenin üslubunu da katıyor. Her Güne Beş Düşünce, Tolstoy'u sadece bir yazar olarak değil, bir editör olarak, bir seçkiler çalışan bir yayıncı olarak karşımıza çıkarır. Kendisini aydınlatan sözleri, kendi aydınlığı içinde bizlere sunarken, okumayı az da olsa her günün alışkanlığı haline getirmemiz de telkin ediyor.<br>(Tanıtım Bülteninden)</p>"
    },
     {
        "itemName":"İnsan Ne İle Yaşar",
        "itemAuthor":"Lev Nikolayeviç Tolstoy",
        "itemImage":"images/insanneileyasar.jpg",
        "itemCreationDate":"2015",
        "itemDescription":"<p>Tolstoy'un,halk için yapılan bir edebiyat nasıl olmalı tartışmalarına yanıt olarak kaleme aldığı hikâyeler bütün dünyada sürekli bir esin kaynağı olmuştur. Konularını daha çok Kutsal Kitap metinlerinden ve halk hikâyelerinden alan Tolstoy, bu hikâyelerinde insanlığı doğruluğa, dürüstlüğe, sevgiye davet eder. İnsan ne ile yaşar? unutulmaz hikâyeler arasına girerken, Bir insana ne kadar toprak lazım? adlı hikâye James Joyce tarafından övülmüş, Wittgenstein'ın sevdiği hikâyeler arasında yer almıştır. Bu hikâyelerin kahramanları genellikle soylular değil, yoksul insanlardır ve Mum adlı hikâyede olduğu gibi halkın angarya ve zorbalığa karşı öfkesi çok açık ifadelerle verilir. Rusça aslından çevrilen bu derleme, günümüzde de Tolstoy'un düşüncesinin ve hayatının merkezi olarak ziyaret edilen Yasnaya Polyana Müzesi yöneticilerinden Galina Alekseyeva'nın önsözüyle sunuluyor.<br>(Tanıtım Bülteninden)</p>"
    }
